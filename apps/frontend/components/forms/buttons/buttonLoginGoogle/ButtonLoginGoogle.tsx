...
import {ButtonLoginGoogleProps} from "./types";
import {getButtonChildren} from "../buttonSubmit/styles";
import {useTranslations} from "next-intl";

export const ButtonLoginGoogle: React.FC<ButtonLoginGoogleProps> = ({ state, ...props }) => {
    ...
    return (
        ...
        >
            ...
            {getButtonChildren(state, t("googleLogin"))}
        </button>
    )
}
